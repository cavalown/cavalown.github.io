---
title: Docker基本操作
summary: A practical Docker command reference covering images, containers, and volumes.
date: 2021-03-23
kind: Technical note
tags:
  - docker
...
- ### 常用指令：
  ...
  ![](https://i.imgur.com/DEvKpF1.png) * Repository: 名稱 * Tag: 標籤 * Image ID: id * Created: 建立時間 * Size: 大小
